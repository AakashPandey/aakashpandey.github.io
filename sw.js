...
self.addEventListener('fetch', e => {
    ...
    if (url.origin === location.origin && (!url.pathname.includes(".")) && (!/howdy|dissolve|uijs|skynotes|leafapp|skyroutes|greetings|MME|sjson|avm/.test(url.pathname)) ) {
